...
# class Student:
#
#     def __init__(self, name, grade,mento,school,stat=0):
#         self.name = name
#         self.grade = grade
#         self.stat = stat
#         self.mento = mento
#         self.school = school
#         self.school.student_countcount += 1
#
# school = School('역삼고', "역삼")
# teacher = Teacher("cho", '수학')
# student = Student("kim",1,'kim')
# teacher.upgrade(student)
#
# print(student.name,student.stat,student.grade)
